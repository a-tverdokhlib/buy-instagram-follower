...
const Panel: React.VFC = () => {
  ...
  const getDynamicComponent = (name) => {
    ...
    switch (name) {
      ...
      case 'package-faq':
        return (
          <PackageFAQ isMobile={isMobile} showOverlay={(b) => setOverlay(b)} />
        )
      case 'services':
        return (
      ...
      case 'settings':
        return <Settings />
      case 'blog':
        return <Blog isMobile={isMobile} showOverlay={(b) => setOverlay(b)} />
      case 'faq':
        return <FAQ isMobile={isMobile} showOverlay={(b) => setOverlay(b)} />
      case 'provider':
        return (
