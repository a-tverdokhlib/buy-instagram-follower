...
export const InstagramAccount: React.VFC<Props> = (props) => {
  return (
    <div className="flex flex-col flex-wrap w-full md:bg-[#222232] md:rounded-none md:p-0 ml:px-14">
      <div className="flex flex-col flex-wrap w-full py-3 pr-3 md:pr-12 md:p-16">
        <div className="flex mt-6 flex-row flex-nowrap w-full h-[30px] md:h-[49px] rounded-r-full bg-gradient-to-r from-transparent via-indigo-500 to-transparent">
