...
export const AutoLikesPlanCard: React.VFC<Props> = (props) => {
  return (
    ...
    >
      ...
      {props.descriptions.map((item, id) => {
        return (
          <div
            key={id}
            className="w-full flex text-sm h-9 text-gray-300 space-x-1 border-b-[1px] border-gray-600 items-center justify-center text-center"
          >
            <svg
