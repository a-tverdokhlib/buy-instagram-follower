...
import { Banner } from '@/components/Instagram-Growth/Banner'
import { Feedback } from '@/components/Instagram-Growth/Feedback'
...
const BuyInstagramGrowPacks: React.VFC = (props: any) => {
...
export default BuyInstagramGrowPacks
