...
const MyComponentRenderFn: ForwardRefRenderFunction<any, Props> = (
  ...
  return (
    <div className="service-card flex mt-16 flex-wrap w-full ls:min-w-[286px] max-w-xs rounded-xl justify-center cursor-pointer bg-[#6345ED] bg-opacity-[0.07] hover:bg-opacity-[0.17] transition-colors duration-300">
