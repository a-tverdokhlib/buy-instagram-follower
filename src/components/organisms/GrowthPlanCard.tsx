  ...
  return (
    ...
    >
      ...
      <div className="w-full flex text-sm h-9 text-gray-300 space-x-1 border-b-[1px] border-gray-600 items-center justify-center text-center">
        ...
        <span>
          <span className="font-semibold text-gray-400">{props.viewDesc}</span>{' '}
        </span>
      </div>
      <div className="w-full flex text-sm h-9 text-gray-300 space-x-1 border-b-[1px] border-gray-600 items-center justify-center text-center">
        <svg
        ...
        <span>
          <span className="font-semibold">{props.likeDesc}</span>
        </span>
      </div>
      <div className="w-full flex text-sm h-9 text-gray-300 space-x-1 border-b-[1px] border-gray-600 items-center justify-center text-center">
        <svg
      ...
      <div className="w-full flex text-sm h-9 text-gray-300 space-x-1 border-b-[1px] border-gray-600 items-center justify-center text-center">
        ...
        <span className="text-[green]">{props.profileVisitDesc}</span>
      </div>
      <div className="w-full flex text-sm h-9 text-gray-300 space-x-1 border-b-[1px] border-gray-600 items-center justify-center text-center">
        <svg
          className="h-4 w-4 text-[green]"
        ...
        <span className="text-[green]">{props.futurePostDesc}</span>
      </div>
      <div className="w-full flex text-sm h-9 text-gray-300 space-x-1 border-b-[1px] border-gray-600 items-center justify-center text-center">
        <svg
          className="h-4 w-4 text-[green]"
