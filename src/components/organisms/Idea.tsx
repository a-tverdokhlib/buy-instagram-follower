...
export const Idea: React.VFC = () => {
  return (
    <div className="flex flex-col flex-wrap md:flex-row md:mt-20">
      ...
      <div className="flex-1 p-12 md:w-7/12 md:mr-16 md:mt-20">
        <h1 className="text-4xl font-medium max-w-full flex flex-wrap">
          <span className="text-[#f15d23]">See why we are the best!</span>
        </h1>
        <br></br>
        <p>
          When you{' '}
          ...
          <span className="text-[#25AAE1]">buy Instagram likes</span> you can
          make a significant amount of money off the Instagram account –
