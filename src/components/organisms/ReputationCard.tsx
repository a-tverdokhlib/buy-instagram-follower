...
const MyComponentRenderFn: ForwardRefRenderFunction<any, Props> = (
  ...
  return (
    <div className="reputation-card-wrapper overflow-hidden w-full ls:min-w-[280px] max-w-xs cursor-pointer rounded-xl">
      <div className="reputation-card overflow-hidden m-auto pb-10  w-full ls:min-w-[280px] max-w-xs justify-center cursor-pointer bg-[#6345ED] bg-opacity-5 transition-all duration-700 rounded-xl">
